...
| **Telemetry Feature Category** | **Sub-Category**            | **CrowdStrike** | **ESET Inspect** | **Elastic** | **LimaCharlie** | **MDE** | **Sentinel One** | **Sysmon** | **Trellix** | **WatchGuard** |
|--------------------------------|-----------------------------|-----------------|------------------|-------------|-----------------|---------|------------------|------------|-------------|----------------|
